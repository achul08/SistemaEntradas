...
public class DaoEstadio implements IDAO<Estadio>{
    ...
    public void insertar(Estadio elemento) throws DaoException {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("INSERT INTO ESTADIO (nombre, direccion, capacidad_total) VALUES (?,?,?)");
    ...
    public void modificar(Estadio elemento) throws DaoException {
        ...
        try {
            Class.forName(DB_JDBC_DRIVER);
            connection = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            preparedStatement = connection.prepareStatement("UPDATE ESTADIO SET nombre=?, direccion=?, capacidad_total=? WHERE id_estadio=?");
